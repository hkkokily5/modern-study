  ...
  return (
    <>
      <section
        ...
        data-overlay-dark="7"
        data-background="/assets/custom/rooms/studyzone.jpg"
        style={{ backgroundImage: 'url(/assets/custom/rooms/studyzone.jpg)' }}
      >
            ...
            <div className="col-lg-4 col-md-12">
              ...
              <div className="project-single-info">
                <ul className="no-margin">
                  ...
                  <li>
                    <span className="vertical-align-top">카테고리:</span>{' '}
                    <span className="value">{category}</span>
                  </li>
                  <li>
                    <span className="vertical-align-top">사용용도:</span>{' '}
